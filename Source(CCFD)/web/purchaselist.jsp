...
<div style="background-image:url(images/saaa.jpg);height: 600px;width: 100%;padding-top: 50px;">
    <%
                try{
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/credit card fraud","root","admin");
                    PreparedStatement check=con.prepareStatement("select * from purchase where email='"+(""+session.getAttribute("email"))+"' ");
    ...
    <div style="height: 300px; width: 900px;box-shadow: 0 40px 48px 0 rgba(0,0,0,0.2);margin-left:250px;margin-top: 50px;padding: 9px 19px">
            <%
                try{
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/credit card fraud","root","admin");
                    PreparedStatement check1=con1.prepareStatement("select * from purchase where email='"+(""+session.getAttribute("email"))+"' ");
                ...
                <% 
                    ...
                    {%>
                      ...
                      <tr>
                          ...
                          <td style="text-align: center;font-family: times "><img src="images/<%=rs1.getString("profile")%>" width="60" height="70"></td>
