...
<div style="background-image:url(images/ee_1.jpg);height: 600px;width: 100%;padding-top: 50px;">
    <%
                try{
                    ...
                    {
                     %>
    <div style="max-height: 400px;overflow-y: scroll; width: 900px;box-shadow: 0 40px 48px 0 rgba(0,0,0,0.2);margin-left:250px;margin-top: 50px;padding: 9px 19px">
            <%
                try{
                    Class.forName("com.mysql.jdbc.Driver");
                    Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/credit card fraud","root","admin");
                    PreparedStatement check1=con1.prepareStatement("select * from product ");
                ...
                <% 
                    ...
                    {%>
                      ...
                      <tr>
                          ...
                          <td style="text-align: center;font-family: times "><a href="update.jsp?pid=<%=rs1.getInt("id")%>" style="text-decoration: none;color: gray;font-family: times">Edit Product</a></td>
