...
<div style="margin-left: 400px;width: 500px;background-color: white;height: 330px;padding-top: 10px;">
    ...
    <form action="otp.jsp" method="post">
        ...
        <h6 style="font-family: times;font-size: 20px;margin-left: 30px;">Enter Your credit card number:&nbsp;&nbsp;</h6><br>
                                    <input type="text" maxlength="4" placeholder="xxxx" name="atm1" required=" " style="width: 80px;margin-left:90px;" >
					<input type="text" maxlength="4" placeholder="xxxx" name="atm2" required=" " style="width: 80px;margin-left: 3px;margin-top: -42px;" >
                                        <input type="text" maxlength="4" placeholder="xxxx"  name="atm3" required=" " style="width: 80px;margin-left: 3px;margin-top: -42px;" >
                                        <input type="text" maxlength="4" placeholder="xxxx"  name="atm4" required=" " style="width: 80px;margin-left: 3px;margin-top: -42px;" ><br>
                                        <h6 style="font-family: times;font-size: 20px;margin-left: 30px;">Enter CVV &nbsp;&nbsp;</h6><br>
					<input type="text" maxlength="3" placeholder="xxx" name="cvv" required=" " style="width: 80px;margin-left:90px;" >
