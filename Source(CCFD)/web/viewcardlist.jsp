...
<div style="background-image:url(images/ee_1.jpg);height: 600px;width: 100%;padding-top: 50px;">
    <%
                try{
                    ...
                    PreparedStatement check=con.prepareStatement("select * from cartlist where email='"+(""+session.getAttribute("email"))+"' ");
    ...
    <div style="height: 300px; width: 900px;box-shadow: 0 40px 48px 0 rgba(0,0,0,0.2);margin-left:250px;margin-top: 50px;padding: 9px 19px">
            <%
                try{
                    ...
                    PreparedStatement check1=con1.prepareStatement("select * from cartlist where email='"+(""+session.getAttribute("email"))+"' ");
